...
date: "`r commandArgs(trailingOnly=T)[2]`"
output:
...
# The first argument is the stat file
# The second argument is timestamp
...
filtered_df$MacroBlockSize <- filtered_df$MacroBlockSize / 1000000
